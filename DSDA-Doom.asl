...
start
{
    ...
    if (current.isMenuOpen == 0 && current.isDemoPlaying == 0 && current.intermission == 0)
    {
...
split
{
    ...
    if (current.intermission == 1 && old.intermission == 0)
    {
        ...
        else
        {
            ...
            vars.totalGameTime += current.levelTics / 35;
        }
...
gameTime
{
    ...
    else
    {
        ...
        if (current.intermission != 0 && old.intermission != 0)
        {
